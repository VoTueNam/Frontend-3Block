  ...
  return (
    <MotionContainer>
      <RootStyle>
        <HeroOverlayStyle
          alt="overlay"
          src="https://votuenam.github.io/image-hosting/background/overlay.svg"
          variants={varFade().in}
        />
        ...
        <Container>
          <ContentStyle>
            ...
            {/* 
            <m.div variants={varFade().inRight}>
              <Typography sx={{ color: 'common.white' }}>Để sửa sau</Typography>
            </m.div> */}
              ...
              <Stack direction="row" spacing={1.5} justifyContent={{ xs: 'center', md: 'flex-start' }}>
                {[
                  ...
                  <m.img
                    ...
                    src={`https://votuenam.github.io/image-hosting/logoIcon/${resource}.svg`}
                  />
                ))}
              </Stack>
            </Stack>
